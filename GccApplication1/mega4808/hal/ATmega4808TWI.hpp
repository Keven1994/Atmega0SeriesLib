...
namespace mega4808 {
    ...
    struct twis {
	    struct twi0 {
		    ...
		    struct I2c_alt2 {
			    struct Scl {
				    using pin0 = AVR::port::details::PortPin<AVR::port::Port<AVR::port::F>,3>;
			    };
			    
			    struct Sda {
				    using pin0 = AVR::port::details::PortPin<AVR::port::Port<AVR::port::F>,2>;
			    };
		    ...
		    struct I2c_alt {
			    struct Scl {
				    using pin0 = AVR::port::details::PortPin<AVR::port::Port<AVR::port::C>,3>;
			    };
			    
			    struct Sda {
				    using pin0 = AVR::port::details::PortPin<AVR::port::Port<AVR::port::C>,2>;
			    };
		    ...
		    struct I2c {
			    struct Scl {
				    using pin0 = AVR::port::details::PortPin<AVR::port::Port<AVR::port::A>,3>;
			    };
			    
			    struct Sda {
				    using pin0 = AVR::port::details::PortPin<AVR::port::Port<AVR::port::A>,2>;
			    };
