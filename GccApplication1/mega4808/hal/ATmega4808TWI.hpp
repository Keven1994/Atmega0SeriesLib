...
namespace mega4808 {
	...
	struct twis {
		struct twi0 {
			...
			struct I2c_alt2 {
				struct Scl {
					using pin0 = AVR::port::details::PortPin<AVR::port::F,3>;
				};
				
				struct Sda {
					using pin0 = AVR::port::details::PortPin<AVR::port::F,2>;
				};
			...
			struct I2c {
				struct Scl {
					using pin0 = AVR::port::details::PortPin<AVR::port::A,3>;
				};
				
				struct Sda {
					using pin0 = AVR::port::details::PortPin<AVR::port::A,2>;
				};
