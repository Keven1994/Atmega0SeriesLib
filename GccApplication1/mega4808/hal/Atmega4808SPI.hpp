...
namespace mega4808 {
	...
	struct spiComponent {
		...
		struct registers {
			...
			using intflags = utils::Pair<reg::Register<reg::accessmode::RW,reg::specialization::Flag,INTFLAGSMasks>,0x3>;
		};
	...
	struct spis {
		struct spi0 {
			...
			struct Spi_alt2 {
				struct Miso {
					using pinE1 = AVR::port::details::PortPin<AVR::port::E,1>;
					using pinC1 = AVR::port::details::PortPin<AVR::port::C,1>;
					using pinA5 = AVR::port::details::PortPin<AVR::port::A,5>;
				};
				
				struct Mosi {
					using pinE0 = AVR::port::details::PortPin<AVR::port::E,0>;
					using pinC0 = AVR::port::details::PortPin<AVR::port::C,0>;
					using pinA4 = AVR::port::details::PortPin<AVR::port::A,4>;
				};
				
				struct Sck {
					using pinE2 = AVR::port::details::PortPin<AVR::port::E,2>;
					using pinC2 = AVR::port::details::PortPin<AVR::port::C,2>;
					using pinA6 = AVR::port::details::PortPin<AVR::port::A,6>;
				};
				
				struct Ss {
					using pinE3 = AVR::port::details::PortPin<AVR::port::E,3>;
					using pinC3 = AVR::port::details::PortPin<AVR::port::C,3>;
					using pinA7 = AVR::port::details::PortPin<AVR::port::A,7>;
				};
