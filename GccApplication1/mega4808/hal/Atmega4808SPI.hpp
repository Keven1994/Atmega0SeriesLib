...
namespace mega4808 {
    ...
    struct spis {
	    struct spi0 {
		    ...
		    struct Spi_alt2 {
			    struct Miso {
				    using pin0 = AVR::port::details::PortPin<AVR::port::E,1>;
			    };
			    
			    struct Mosi {
				    using pin0 = AVR::port::details::PortPin<AVR::port::E,0>;
			    };
			    
			    struct Sck {
				    using pin0 = AVR::port::details::PortPin<AVR::port::E,2>;
			    };
			    
			    struct Ss {
				    using pin0 = AVR::port::details::PortPin<AVR::port::E,3>;
			    };
		    ...
		    struct Spi_alt {
			    struct Miso {
				    using pin0 = AVR::port::details::PortPin<AVR::port::C,1>;
			    };
			    ...
			    struct Sck {
				    using pin0 = AVR::port::details::PortPin<AVR::port::C,2>;
			    };
			    
			    struct Ss {
				    using pin0 = AVR::port::details::PortPin<AVR::port::C,3>;
			    };
		    ...
		    struct Spi {
			    struct Miso {
				    using pin0 = AVR::port::details::PortPin<AVR::port::A,5>;
			    };
			    
			    struct Mosi {
				    using pin0 = AVR::port::details::PortPin<AVR::port::A,4>;
			    };
			    
			    struct Sck {
				    using pin0 = AVR::port::details::PortPin<AVR::port::A,6>;
			    };
			    
			    struct Ss {
				    using pin0 = AVR::port::details::PortPin<AVR::port::A,7>;
			    };
