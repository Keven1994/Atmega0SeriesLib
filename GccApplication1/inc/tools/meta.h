...
namespace Meta {
	...
	namespace detail {
		...
		template<typename,typename> struct contains_any_impl;
	}
	...
	struct contains_any : std::integral_constant<bool, detail::contains_any_impl<List, List2>::value>{};
	
	template<concepts::List L1, concepts::List L2>
	using concat_t = typename detail::concat_impl<L1, L2>::type;
	...
	namespace detail {
		...
		template<typename, typename> struct contains_any_impl {};
		template<template<typename...> typename L1, typename... I1, template<typename...> typename L2, typename... I2>
		struct contains_any_impl<L1<I1...>, L2<I2...>> {
			using type = std::integral_constant<bool, (contains_impl<L1<I1...>, I2>::value || ... || false)>;
...
namespace tests {
	...
	using l400 = Meta::concat_t<l300, l301>;
