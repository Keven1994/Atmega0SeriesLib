...
#include "mega4809/hal/Atmega4809EventSystem.hpp"
...
namespace mega4809 {
    ...
    public:
        ...
        struct Port {
            ...
            typename utils::condEqual<AVR::port::B, p, port_details::port<port_details::ports::portb>,
            ...
            typename utils::condEqual<AVR::port::E, p, port_details::port<port_details::ports::porte>,
        ...
        struct EventSystem {
            ...
            using users = mega4809::details::users;
        };
        ...
        private:
            using Component_t = mega4809::twi_details::twiComponent;
        };
