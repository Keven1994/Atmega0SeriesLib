    ...
    namespace port_details {
        struct portComponent {
            ...
            struct registers {
                ...
                portctrl::type Portctrl;
                volatile mem_width reserved11;
                volatile mem_width reserved12;
                volatile mem_width reserved13;
                volatile mem_width reserved14;
                volatile mem_width reserved15;
                pin0ctrl::type Pin0ctrl;
                pin1ctrl::type Pin1ctrl;
                pin2ctrl::type Pin2ctrl;
                pin3ctrl::type Pin3ctrl;
                pin4ctrl::type Pin4ctrl;
                pin5ctrl::type Pin5ctrl;
        ...
        struct ports {
            ...
            struct portb {
                [[nodiscard,gnu::always_inline]] static inline auto& value()  { return PORTB;}
            
                struct Pin {
                    using pin0 = AVR::port::details::PortPin<port_details::port<port_details::ports::portb>,0>;
                    using pin1 = AVR::port::details::PortPin<port_details::port<port_details::ports::portb>,1>;
                    using pin2 = AVR::port::details::PortPin<port_details::port<port_details::ports::portb>,2>;
                    using pin3 = AVR::port::details::PortPin<port_details::port<port_details::ports::portb>,3>;
                    using pin4 = AVR::port::details::PortPin<port_details::port<port_details::ports::portb>,4>;
                    using pin5 = AVR::port::details::PortPin<port_details::port<port_details::ports::portb>,5>;
                    using list = Meta::List<pin0, pin1, pin2, pin3, pin4, pin5>;
                };
            ...
            struct portc {
                ...
                struct Pin {
                    ...
                    using pin4 = AVR::port::details::PortPin<port_details::port<port_details::ports::portc>,4>;
                    using pin5 = AVR::port::details::PortPin<port_details::port<port_details::ports::portc>,5>;
                    using pin6 = AVR::port::details::PortPin<port_details::port<port_details::ports::portc>,6>;
                    using pin7 = AVR::port::details::PortPin<port_details::port<port_details::ports::portc>,7>;
                    using list = Meta::List<pin0, pin1, pin2, pin3, pin4, pin5, pin6, pin7>;
                };
            ...
            struct porte {
                [[nodiscard,gnu::always_inline]] static inline auto& value()  { return PORTE;}
            
                struct Pin {
                    using pin0 = AVR::port::details::PortPin<port_details::port<port_details::ports::porte>,0>;
                    using pin1 = AVR::port::details::PortPin<port_details::port<port_details::ports::porte>,1>;
                    using pin2 = AVR::port::details::PortPin<port_details::port<port_details::ports::porte>,2>;
                    using pin3 = AVR::port::details::PortPin<port_details::port<port_details::ports::porte>,3>;
