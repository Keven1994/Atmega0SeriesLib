    ...
    namespace twi {
        ...
        namespace details {
            ...
            struct Command {
                ...
                void operator=(const volatile Command &other) {
            ...
            struct Command<true> {
                ...
                Command(uint8_t address, uint8_t bytes) : address(address), bytes(bytes) {}
            };
            ...
            protected:
                ...
                using stack_t = std::conditional_t<!_TWI::InterruptEnabled , etl::FiFo<command, 10>, volatile etl::FiFo<command, 10>>;
                ...
                static inline void writeCondition() {
                    reg<Addr>().set(current.address);
                }

                static inline void readCondition() {
                    reg<Addr>().set(current.address & 1);
                }
            ...
            public:
                ...
                static inline void init() {
                    ...
                    //using test = std::integral_constant<uint8_t,baudrate>;
                    //test::_;
                    ...
                    TWIMaster::template reg<typename TWIMaster::_Ctrla>().set(Setting::quickcommand, Setting::smartmode,
                                                                              Setting::timeout,
